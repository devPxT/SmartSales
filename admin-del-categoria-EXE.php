            ...
            <p class="w3-large">
                <div class="w3-code cssHigh notranslate">
                    ...
                    <?php
                        ...
                        $sql = "SELECT id FROM produto WHERE categoria_id = $id";
                        ...
                        if ($result = $conn->query($sql)) {
                            ...
                            if ($result -> num_rows > 0) {
                                ...
                                if ($result = mysqli_query($conn, $sql)) {
                                    ...
                                    if ($result = mysqli_query($conn, $sql)) {
                                        ...
                                        echo "<p>&nbsp;Erro executando DELETE DA CATEGORIA: " . $conn -> error. "</p>";
                                    }
                                } else {
                                    echo "<p>&nbsp;Erro executando DELETE DO PRODUTO: " . $conn -> error. "</p>";
                                }
                            ...
                            echo "<p>&nbsp;Erro executando SELECT DO PRODUTO: " . $conn -> error. "</p>";
                        }
                        echo "</div>";
                        $conn->close();
