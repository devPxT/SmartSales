...
<body id="cadastro">
    ...
    <div class="w3-main w3-container" style="flex: 1">
            ...
            <p class="w3-large">
                <div class="w3-code cssHigh notranslate">
                    ...
                    <?php
                        ...
                        $sql = "SELECT id FROM fornecedor WHERE id = $id";
                        ...
                        if ($result = $conn->query($sql)) {
                            ...
                            if ($result -> num_rows > 0) {
                                ...
                                if ($result = mysqli_query($conn, $sql)) {
                                    $sql2 = "DELETE FROM fornecedor WHERE id = $id";
                                    if ($result = mysqli_query($conn, $sql)) {
                                        echo "<p>&nbsp;Registro excluído com sucesso! </p>";
                                    } else {
                                        echo "<p>&nbsp;Erro executando DELETE DO FORNECEDOR: " . $conn -> error. "</p>";
                                    }
                                } else {
                                    echo "<p>&nbsp;Erro executando DELETE DO FORNECEDOR: " . $conn -> error. "</p>";
                                }
                            ...
                            echo "<p>&nbsp;Erro executando SELECT DO FORNECEDOR: " . $conn -> error. "</p>";
                        }
                        echo "</div>";
                        $conn->close();
        ...
        <div class="col-lg-1 col-sm-2 col-12">
            <button type="button" class="btn btn-secondary mb-3 w-100" onclick="window.location.href='estoquista-lst-fornecedor.php'">Voltar</button>
        </div>
