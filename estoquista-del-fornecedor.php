        ...
        <div class="w3-panel w3-padding-large w3-card-4 w3-light-grey" >
            ...
            <p class="w3-large">
                <div class="w3-code cssHigh notranslate">
                    ...
                    $sql = "SELECT t1.id, t1.nome, t1.data_cad, t1.data_updt FROM fornecedor t1 WHERE t1.id = $id";
                    ...
                    <div class="w3-responsive w3-card-4">
                        <div class="w3-container w3-theme">
                            <h2>Exclusão do Fornecedor Cód. [<?php echo $id ?>]</h2>
                        </div>
                        <form class="w3-container" action="estoquista-del-fornecedor-EXE.php" method="post" enctype="multipart/form-data">
