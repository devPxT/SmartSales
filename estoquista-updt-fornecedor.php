        ...
        <div class="w3-panel w3-padding-large w3-card-4 w3-light-grey" >
            ...
            <p class="w3-large">
                <div class="w3-code cssHigh notranslate">
                    ...
                    $sql = "SELECT t1.id, t1.nome, t1.data_cad FROM fornecedor t1 WHERE id = $id";
                    ...
                    <div class="w3-responsive w3-card-4">
                        <div class="w3-container w3-theme">
                            <h2>Informe os dados do Fornecedor a serem Atualizados</h2>
                        </div>
                        <form class="w3-container" action="estoquista-updt-fornecedor-EXE.php" method="post" enctype="multipart/form-data">
                        <table class='w3-table-all'>
                        <tr>
                            <td>
                                <input class="w3-input w3-border w3-light-grey" name="id" type="hidden" min="1" step="1"
                                    value="<?php echo $id; ?>" title="Código do fornecedor." required>
