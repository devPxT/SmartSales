    ...
    <div class="w3-main w3-container" style="flex: 1;">
        ...
        <!-- Acesso em:-->
            ...
            <?php
                ...
                $sql = "INSERT INTO metodopagamento (nome, descricao, data_cad) VALUES ('$nome', '$descricao', '$data_cad')";

                ?>
                <div class='w3-responsive w3-card-4'>
                <div class="w3-container w3-theme">
                    <h2>Inclusão de Novo Método de Pagamento</h2>
                </div>
                <?php
        ...
        <div class="col-lg-1 col-sm-2 col-12">
            <button type="button" class="btn btn-primary mb-3" onclick="window.location.href='vendedor-lst-metodopagamento.php'" style="width: 100%">Voltar</button>
        </div>
    </div>
