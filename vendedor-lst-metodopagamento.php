...
<body id="cadastro">
    ...
    <div class="container-fluid mt-3 home">
        ...
        <div class="container-fluid mt-3">
            <form action="vendedor-lst-metodopagamento.php" method="post">
                <div class="row">
                    <div class="col-lg-2 col-sm-2 col-3">
                        <button type="button" class="btn btn-primary mb-3 w-100" onclick="window.location.href='vendedor-cad-metodopagamento.php'">Novo</button>
                    </div>
                    <div class="col-lg-6 col-sm-7 col-9">
                            <label for="inputPesquisa" class="visually-hidden">Pesquisar</label>
                            <input type="text" name="nomeMetodoPagamento" class="form-control mb-3" id="inputPesquisa" placeholder="Nome do Método de Pagamento..."
                                value="<?php echo isset($_POST['nomeMetodoPagamento']) ? $_POST['nomeMetodoPagamento'] : ''; ?>">
                    </div>
        ...
        <div class="container-fuid mt-3 ms-lg-2 me-lg-2 shadow-lg rounded-3">
            ...
            <?php
                ...
                if (isset($_POST['nomeMetodoPagamento'])) {
                    $nomeMetodoPagamento = $_POST['nomeMetodoPagamento'];
                }
                // Faz Select na Base de Dados
                $sql = "SELECT t1.id, t1.nome, t1.descricao, t1.data_cad, t1.data_updt FROM metodopagamento t1";
                // If Isset para verificar se recebeu o NomeCategoria para concatenar o WHERE e fazer a pesquisa
                if (isset($nomeMetodoPagamento)) {
                    $sql = $sql . " WHERE t1.nome LIKE '$nomeMetodoPagamento%'";
                }
                ...
                ?>                      
                                <td>
                                    ...
                                    onclick="window.location.href='vendedor-del-metodopagamento.php?id=<?php echo $cod; ?>'">
                                    ...
                                    onclick="window.location.href='vendedor-updt-metodopagamento.php?id=<?php echo $cod; ?>'">
